...
*   Many useful latex packages are integrated (see `Preamble`), specifically helpful while 1) thesis review (see lines 34-38 `Preamble.tex` ), 2) to provide 'epigraph' at the beginning of each chapter, 3) 'to-do notes' etc..
